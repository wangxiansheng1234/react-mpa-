...
<link href=${filePath.styles.passwordBack} rel="stylesheet" >
</head>
<body>
...
<script src=${filePath.javascript.passwordBack} type="text/javascript"></script>
</html>
    `
};

let passwordBack = (req, res) => {

    let html = renderToString(<PasswordBack/>);
