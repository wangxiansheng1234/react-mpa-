...
<link href=${filePath.styles.orderDetails} rel="stylesheet" >
</head>
<body>
...
<script src=${filePath.javascript.orderDetails} type="text/javascript"></script>
</html>
    `
};
...
let orderDetails = (req, res) => {
    ...
    let html = renderToString(<OrderDetails/>);
