...
<link href=${filePath.styles.orderManage} rel="stylesheet" >
</head>
<body>
...
<script src=${filePath.javascript.orderManage} type="text/javascript"></script>
</html>
    `
};

let orderManage = (req, res) => {

    let html = renderToString(<OrderManager />);
