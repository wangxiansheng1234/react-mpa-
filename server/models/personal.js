...
<link href=${filePath.styles.personal} rel="stylesheet" >
</head>
<body>
...
<script src=${filePath.javascript.personal} type="text/javascript"></script>
</html>
    `
};

let personal = (req, res) => {
    let html = renderToString(<Personal/>);
