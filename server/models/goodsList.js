...
<link href=${filePath.styles.goodsList} rel="stylesheet" >
</head>
<body>
...
<script src=${filePath.javascript.goodsList} type="text/javascript"></script>
</html>
    `
};

let goodsList = (req, res) => {

    let html = renderToString(<GoodsList />);
